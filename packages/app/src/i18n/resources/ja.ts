...
export const ja: TranslationResources = {
  ...
  composer: {
    ...
    attachments: {
      ...
      restoreUncertainMessage: "メッセージを入力欄に戻す",
      retryUncertainMessage: "配信が不確かなメッセージを再試行",
      discardUncertainMessageAction: "メッセージを破棄",
      discardUncertainTitle: "配信が不確かなメッセージを破棄しますか？",
      discardUncertainMessage:
        "ホストでこのコマンドを破棄済みにします。すでに完了した配信は元に戻せません。",
      deliveryUnknown: "配信状況が不明",
      deliveryInFlight: "確認が必要",
      deliveryRejected: "未送信",
  ...
  pairing: {
    ...
    device: {
      ...
      noPairedDevices: "ペアリング済みデバイスはありません",
