...
export const ar: TranslationResources = {
  ...
  composer: {
    ...
    attachments: {
      ...
      restoreUncertainMessage: "استعادة الرسالة إلى المحرر",
      retryUncertainMessage: "إعادة محاولة الرسالة غير المؤكدة",
      discardUncertainMessageAction: "تجاهل الرسالة",
      discardUncertainTitle: "تجاهل الرسالة غير المؤكدة؟",
      discardUncertainMessage:
        "سيضع المضيف علامة متجاهلة على هذا الأمر. لا يمكن التراجع عن إرسال اكتمل بالفعل.",
      deliveryUnknown: "حالة الإرسال غير مؤكدة",
      deliveryInFlight: "يتطلب تأكيدًا",
      deliveryRejected: "لم تُرسل",
  ...
  pairing: {
    ...
    device: {
      ...
      noPairedDevices: "لا توجد أجهزة مقترنة",
      unknownDevice: "جهاز غير معروف",
      revoke: "إلغاء الاقتران",
