...
export const ptBR: TranslationResources = {
  ...
  composer: {
    ...
    attachments: {
      ...
      restoreUncertainMessage: "Restaurar mensagem no editor",
      retryUncertainMessage: "Tentar novamente a mensagem com entrega incerta",
      discardUncertainMessageAction: "Descartar mensagem",
      discardUncertainTitle: "Descartar a mensagem com entrega incerta?",
      discardUncertainMessage:
        "O host marcará este comando como descartado. Uma entrega já concluída não pode ser desfeita.",
      deliveryUnknown: "Entrega incerta",
      deliveryInFlight: "Confirmação necessária",
      deliveryRejected: "Não enviada",
