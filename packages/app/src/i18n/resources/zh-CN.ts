...
export const zhCN: TranslationResources = {
  ...
  composer: {
    ...
    attachments: {
      ...
      restoreUncertainMessage: "将消息恢复到输入框",
      retryUncertainMessage: "重试状态不确定的消息",
      discardUncertainMessageAction: "丢弃消息",
      discardUncertainTitle: "丢弃状态不确定的消息？",
      discardUncertainMessage: "主机将把此命令标记为已丢弃。已完成的发送无法撤销。",
      deliveryUnknown: "发送状态不确定",
      deliveryInFlight: "需要确认",
      deliveryRejected: "未发送",
      openImage: "打开图片附件",
      removeImage: "移除图片附件",
