...
export const ru: TranslationResources = {
  ...
  composer: {
    ...
    attachments: {
      ...
      restoreUncertainMessage: "Вернуть сообщение в редактор",
      retryUncertainMessage: "Повторить сообщение с неопределённой доставкой",
      discardUncertainMessageAction: "Отменить сообщение",
      discardUncertainTitle: "Отменить сообщение с неопределённой доставкой?",
      discardUncertainMessage:
        "Хост пометит эту команду как отменённую. Уже завершённую доставку нельзя отменить.",
      deliveryUnknown: "Доставка не подтверждена",
      deliveryInFlight: "Требуется подтверждение",
      deliveryRejected: "Не отправлено",
  ...
  workspace: {
    ...
    browser: {
      ...
      popups: {
        show: "Показать всплывающие окна ({{count}})",
        returnToPage: "Вернуться на страницу",
        previous: "Предыдущее всплывающее окно",
        next: "Следующее всплывающее окно",
        close: "Закрыть всплывающее окно",
        closeFailed: "Не удалось закрыть всплывающее окно",
      },
      annotate: {
