...
export const es: TranslationResources = {
  ...
  composer: {
    ...
    attachments: {
      ...
      restoreUncertainMessage: "Restaurar mensaje en el editor",
      retryUncertainMessage: "Reintentar mensaje con entrega incierta",
      discardUncertainMessageAction: "Descartar mensaje",
      discardUncertainTitle: "¿Descartar el mensaje con entrega incierta?",
      discardUncertainMessage:
        "El host marcará este comando como descartado. Una entrega ya completada no se puede deshacer.",
      deliveryUnknown: "Entrega incierta",
      deliveryInFlight: "Requiere confirmación",
      deliveryRejected: "No enviado",
