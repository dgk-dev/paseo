export const en = {
  ...
  composer: {
    ...
    attachments: {
      ...
      restoreUncertainMessage: "Restore message to the composer",
      retryUncertainMessage: "Retry uncertain message",
      discardUncertainMessageAction: "Discard message",
      discardUncertainTitle: "Discard uncertain message?",
      discardUncertainMessage:
        "The host will mark this command as discarded. Any delivery that already completed cannot be undone.",
      deliveryUnknown: "Delivery uncertain",
      deliveryInFlight: "Confirmation needed",
      deliveryRejected: "Not sent",
