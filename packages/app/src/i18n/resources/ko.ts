...
export const ko: TranslationResources = {
  ...
  composer: {
    ...
    attachments: {
      ...
      restoreUncertainMessage: "작성창으로 메시지 복원",
      retryUncertainMessage: "전송이 불확실한 메시지 재시도",
      discardUncertainMessageAction: "메시지 폐기",
      discardUncertainTitle: "전송이 불확실한 메시지를 폐기할까요?",
      discardUncertainMessage:
        "호스트에서 이 명령을 폐기 처리합니다. 이미 완료된 전송은 되돌릴 수 없습니다.",
      deliveryUnknown: "전송 여부 불확실",
      deliveryInFlight: "확인 필요",
      deliveryRejected: "전송되지 않음",
      openImage: "이미지 첨부 열기",
