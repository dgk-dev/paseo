...
export const fr: TranslationResources = {
  ...
  composer: {
    ...
    attachments: {
      ...
      restoreUncertainMessage: "Restaurer le message dans l'éditeur",
      retryUncertainMessage: "Réessayer le message à livraison incertaine",
      discardUncertainMessageAction: "Abandonner le message",
      discardUncertainTitle: "Abandonner le message à livraison incertaine ?",
      discardUncertainMessage:
        "L'hôte marquera cette commande comme abandonnée. Une livraison déjà terminée ne peut pas être annulée.",
      deliveryUnknown: "Livraison incertaine",
      deliveryInFlight: "Confirmation requise",
      deliveryRejected: "Non envoyé",
  ...
  pairing: {
    ...
    device: {
      ...
      noPairedDevices: "Aucun appareil associé",
