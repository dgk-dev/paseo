...
export class ProviderSnapshotManager {
  ...
  stageMutableProviderConfig(
    ...
    try {
      ...
      // Preserve registry entries, clients, in-flight loads, and cached catalogs for
      // providers whose effective configuration did not change. Rebuilding everything
      // turned an unrelated edit (a model default, another provider's label) into a
      // probe burst that could flip healthy providers to loading/error.
      ...
      Object.assign(this.providerClients, this.extraClients);
